...
- ⚔️ **Neues Match** eintragen – 4 Spieler-Chips antippen (erste zwei = Team A, nächste zwei = Team B), Punkte per **Voreinstellung (15–21)** oder −/＋-Stepper wählen, speichern; optional **Punkte-Details** erfassen (Spieler wählen → die Aktion, die zum Punkt geführt hat: 💥 Kill/Aufschlag, 🛡️ Block, 🖐️ Annahme-Fehler, 🎯 Zuspiel-Fehler, ⚔️ Angriffs-Fehler, 🎲 Sonstiges) – der Punkt zählt immer für **das Team des gewählten Spielers** und erhöht dessen Punktestand automatisch, ohne Einfluss auf Elo/Ranking; „gemischt“ (⚧) wird aus unterschiedlichen Geschlechtern im Team automatisch erkannt
