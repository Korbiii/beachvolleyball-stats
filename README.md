...
- ⚔️ **Neues Match** eintragen – 4 Spieler-Chips antippen (erste zwei = Team A, nächste zwei = Team B), Punkte per **Voreinstellung (15–21)** oder −/＋-Stepper wählen, speichern; optional **Punkte-Details** erfassen (Spieler direkt wählen → Wie: 💥 Kill, 🛡️ Block, 🖐️ Annahme-Fehler, ⚠️ Gegnerfehler, 🎲 Sonstiges; das Team steht automatisch fest) – zählt den Punktestand des Teams automatisch mit, ohne Einfluss auf Elo/Ranking; „gemischt“ (⚧) wird aus unterschiedlichen Geschlechtern im Team automatisch erkannt
